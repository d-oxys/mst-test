...
import TableOne from '../Tables/TableTwo';
  ...
  return (
    <>
      <div className='2xl:gap-7.5 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4'>
        <CardDataStats title='Total views' total={5} rate='0.43%' levelUp>
        ...
        <CardDataStats title='Total Product' total={productData ? productData.length : 0} rate='2.59%' levelUp>
        ...
        <CardDataStats title='Total Users' total={customerData ? customerData.length : 0} rate='0.95%' levelDown>
